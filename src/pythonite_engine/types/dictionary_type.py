...
class DictionaryTypeRepresentation(TypeRepresentation):
    """
    Represents a DictionaryType in the PythoniteEngine.
    """

    __pythonite_signature__: ClassVar[str] = "DictionaryType"
    ...
    def convert_value(self, value: Any) -> dict:
        ...
        try:
            ...
            raise ConversionError(f"Could not convert {value} to dict.")
