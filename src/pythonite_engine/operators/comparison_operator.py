...
class ComparisonOperatorRepresentation(OperatorRepresentation):
    """
    Represents an comparison operator in the Pythonite engine.

    Attributes:
        operator (str): The comparison operator that the object represents.
        operands (list[Any]): The operands that the operator operates on.
    """

    __pythonite_signature__: ClassVar[str] = "ComparisonOperator"
